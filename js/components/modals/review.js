...
const ReviewModal = {
    ...
    open: (activityId) => {
        ...
        const levels = [
            {l:TXT.CORE.SCORES[1],s:1}, {l:TXT.CORE.SCORES[2],s:2}, {l:TXT.CORE.SCORES[3],s:3}, {l:TXT.CORE.SCORES[4],s:4}
        ];
    ...
    submit: async () => {
        ...
        const btn = document.querySelector('#reviewModal button.submit-btn');
        const oldText = btn.innerText;
        btn.innerText = TXT.COMPONENTS.MODALS.REVIEW.BTN_SUBMITTING; btn.disabled = true;
