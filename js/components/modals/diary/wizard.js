...
const DiaryWizard = {
    ...
    init: () => {
        ...
        if(backBtn) {
            ...
            console.log('DiaryWizard: Back button hidden on init'); // Temp debug: Remove after testing
        }
    ...
    updateHeader: (txt) => {
        ...
        if(backBtn) {
            ...
            console.log('DiaryWizard: Back button shown'); // Temp debug: Remove after testing
        } else {
