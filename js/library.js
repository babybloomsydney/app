/**
 * STATIC LIBRARY (Performance Optimization)
 * Pre-loaded milestones so the app doesn't have to fetch them from GAS.
 */
...
const LIBRARY_DATA = [
    ...
    // Numeracy (NUM)
    { id: "NUM-03-A", domain: "NUM", age: "0-3 months", desc: "Notices patterns and routines (e.g., feeding times)" },
    { id: "NUM-03-B", domain: "NUM", age: "0-3 months", desc: "Recognizes faces and objects" },
    { id: "NUM-03-C", domain: "NUM", age: "0-3 months", desc: "Responds to number songs (rhythm)" },
